...
namespace Poced.Logging.Web
{
    ...
    {
        public static void LogWebUsage(this IPocedLogger logger, string product, string layer, string activityName, 
        ...
        public static void LogWebDiagnostic(this IPocedLogger logger, IConfiguration configuration, string product, string layer, string message, 
            Dictionary<string, object> diagnosticInfo = null)
        {
            var writeDiagnostics = Convert.ToBoolean(configuration.GetConfigurationValue("EnableDiagnostics"));
        ...
        internal static void GetLocationForApiCall(this HttpRequestContext requestContext,
