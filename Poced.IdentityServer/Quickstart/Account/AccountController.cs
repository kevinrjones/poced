...
namespace Poced.IdentityServer.Quickstart.Account
{
    [SecurityHeaders]
    public class AccountController : Controller
    {
        ...
        public AccountController(
            UserManager<PocedUser> userManager,
            SignInManager<PocedUser> signInManager,
        ...
        private async Task<(PocedUser user, string provider, string providerUserId, IEnumerable<Claim> claims)> 
